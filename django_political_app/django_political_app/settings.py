...
ALLOWED_HOSTS = os.environ.get('ALLOWED_HOSTS', '127.0.0.1,localhost,0.0.0.0,django-container').split(',')
...
DB_HOST = os.environ.get("POSTGRES_HOST", "db") # "db" est le nom du service dans docker-compose
